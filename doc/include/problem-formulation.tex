...
\updated{The system depends on a set of process parameters, which are uncertain at the design stage; these parameters are denoted by a random vector $\vU(\o)$.
