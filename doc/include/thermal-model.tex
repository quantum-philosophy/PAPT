...
In the deterministic case, the analytical solution, which leads to the recurrence given by \eref{recurrence}, can readily be employed to perform the deterministic transient TA, cf. \cite{ukhov2012}. In the stochastic case, however, where $\vX_k(\t, \o)$, $\vTO_k(\t, \o)$, and $\vP_k(\t, \o)$ are probabilistic quantities, a straight-forward analysis of \eref{recurrence} is difficult to undertake due to the existence of nonlinear correlations between successive steps. In order to tackle this problem, we employ the mathematical framework introduced in \sref{introduction} and further discussed in the following subsection.
