...
Hence, we fix $\pcorder$ to four for the assessment of the computational speed given in \sref{er-speed}.
The MC estimates, on the other hand, can be considered as sufficiently reliable starting from $\nsamples = 10^4$.
This conclusion, however, is in favor of the MC technique since, as we noted earlier, there is strong evidence that $10^4$ samples are still not enough, which also conforms to the theoretical estimates of the accuracy of MC sampling \cite{diaz-emparanza2002} and to the experience from the literature \cite{maitre2010, shen2009, eldred2008}.
