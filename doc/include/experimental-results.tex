...
Dynamic power profiles involved in the experiments are based on simulations of randomly generated, \via\ TGFF (v3.5) \cite{dick1998}, applications defined as directed acyclic task graphs.\footnote{\updated{In practice, dynamic power profile are typically obtained using adequate full-system/cycle-accurate simulators capable of modeling power.}}
