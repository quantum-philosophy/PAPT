...
Note also that, since the two temperature-driven studies \cite{juan2011, juan2012} work under the steady-state assumption, and \cite{juan2011}, in addition, is limited to the maximal temperature (see \sref{prior-work}), a one-to-one comparison with our framework is not possible.}
