...
The MC approach is set to preserve the whole variance of the problem, \ie, no model order reduction, and it solves the system in \eref{fourier-system} directly using the fourth- and fifth-order Runge-Kutta formulae (the Dormand-Prince method) \cite{press2007} available in MATLAB \cite{matlab}.
