...
It is worth noting that the temperature-related studies discussed in \sref{prior-work} either address the maximal temperature or work under the steady-state assumption; therefore, a one-to-one comparison with the proposed framework is not possible.}
