...
Taking into account the variances of all the variable, the final covariance matrix of the whole random vector $\vU(\o)$ (see \eref{uncertain-parameters}) is formed, which we denote by $\mCorr_\vU$.
