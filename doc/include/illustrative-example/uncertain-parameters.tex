...
Second, the correlations of the obtained Gaussian variables are removed using the discrete version of the KL decomposition (see \sref{uncertain-parameters}).
...
Therefore, one should consider a possibility of model order reduction before constructing PC expansions (call \sref{uncertain-parameters}).
