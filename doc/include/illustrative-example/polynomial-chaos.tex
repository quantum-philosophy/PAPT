...
\updated{These points along with the corresponding weights are generally precomputed and tabulated since they do not depend the function to integrate (see \aref{gauss-quadrature}); for this purpose, we use the library of MATLAB codes available at \cite{burkardt2013}.}
