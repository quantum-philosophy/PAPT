...
\done{The absence of requirements to input workloads has been noted in Sec.~IV.}

\done{Practical aspects of input workloads have been outlined in Sec.~VII.}
\end{authors}
...
\done{[Kreith, 2000] and [HotSpot] have been replaced by [Skadron, 2004], mentioned above, which is more concrete and well suited for the discussions in the paper.}
\end{authors}
...
\done{The same issue has been addressed with respect to Fig.~3, Fig.~4, Fig.~5, and Fig.~6.}
\end{authors}
