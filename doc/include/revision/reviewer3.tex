...
To tackle the difficulty, [S. Bhardwaj \etal, 2008] pulls this ``inconvenient'' term inside the exponent using the usual exp/ln transformation, as shown in App.~A in that paper.
...
\done{[S. Bhardwaj \etal, 2008] has been reviewed and cited.}
\end{authors}
...
Note also that this order is higher than the one used for power in the PC-related literature discussed in Sec.~II: typically, it is the second order (see, \eg, [S. Bhardwaj \etal, 2008] and [Shen \etal, 2009]).
...
The dependency of the threshold voltage to the effective channel length is one of the strongest [R. Shen \etal, 2009] [D.-C. Juan \etal, 2011, 2012].
