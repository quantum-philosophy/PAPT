...
Hence, conclusions with respect to power are not directly applicable to temperature as there is not a straightforward relation between them.
...
All the prior studies listed in Sec.~II that perform comparisons with MC simulations in terms of accuracy and/or speed, namely, [Vrudhula, 2006], [Bhardwaj, 2006], [Ghanta, 2006], [Bhardwaj, 2008], [Shen, 2009], [Chandra, 2010], [Juan, 2011], and [Juan, 2012], postulate their choices regarding the number of MC samples.
