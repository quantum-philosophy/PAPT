...
\updated{For instance, in the example given earlier, the number of nodes computed by the algorithm would be only $1,581$, which implies drastic savings of the computational time.}
