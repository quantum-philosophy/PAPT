This section contains a description of the discrete Karhunen-Lo\`{e}ve decomposition \cite{ghanem1991},\footnote{The KL expansion can also be recognized as the eigenvalue decomposition, singular value decomposition, principal component analysis, \etc} which is utilized at \stage{1}\ for the purpose of model order reduction.
