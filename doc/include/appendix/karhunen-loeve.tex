In this section, the discrete version of the Karhunen-Lo\`{e}ve decomposition \cite{ghanem1991} is described, which can also be recognized as the eigenvalue decomposition, singular value decomposition, principal component analysis, \etc\ We shall use the notation introduced in \sref{ie-uncertain-parameters}.
