...
\stage{1}{Uncertain Parameters (\sref{uncertain-parameters}).} In the scenario at hand, the transformation $\U(\o) = \oTransform{\Z(\o)}$ involves only centring and normalization of $\Leff(\o)$. Therefore,
...
\input{include/assets/temperature.tex}

\stage{5}{Post-processing (\sref{output-processing}).}
