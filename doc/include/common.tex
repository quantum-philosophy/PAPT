...
% ---- Graphics
\definecolor{iblue}{RGB}{1,173,206}
\definecolor{iorange}{RGB}{235,113,39}
\definecolor{iyellow}{RGB}{195,167,6}
\definecolor{igreen}{RGB}{102,204,0}
\definecolor{ipink}{RGB}{214,48,86}

\newcommand{\step}[3]{\textbf{Step #1.}\hspace{0.5em}\emph{#2}}

\newcommand{\stepOne}[1]{\step{1}{#1}{iblue}}
\newcommand{\stepTwo}[1]{\step{2}{#1}{iorange}}
\newcommand{\stepThree}[1]{\step{3}{#1}{iyellow}}
\newcommand{\stepFour}[1]{\step{4}{#1}{igreen}}
\newcommand{\stepFive}[1]{\step{5}{#1}{ipink}}
...
\newcommand{\profB}[1]{\Pi\lfloor\part, #1\rfloor}
\newcommand{\profE}[1]{\Pi\lceil\part, #1\rceil}
