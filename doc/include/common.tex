...
\usepackage[maxnames=1, sorting=none]{biblatex}
...
\newcommand{\blindreview}{\textnormal{$\langle \hspace{0.5em} \text{HIDDEN FOR BLIND REVIEW} \hspace{0.5em} \rangle$}}

% ---- Helpers
\newcommand{\step}[2]{\textbf{Step #1.}\hspace{0.5em}\emph{#2}}
