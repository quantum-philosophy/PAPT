...
Note that, as shown in \eref{power-model}, $\vP(\t, \o)$ is an arbitrary function of $\vTO(\t, \o)$.
...
Therefore, the operations involved in \eref{recurrence} are to be performed on dependent random variables with arbitrary probability distributions, which, in general, have no closed-form solutions.
