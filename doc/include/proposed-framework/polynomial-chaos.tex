...
In contrast, a typical solution from the literature related to process variation is saturated with ad hoc expressions and should be tailored by the user for each new parameter individually; see, \eg, \cite{bhardwaj2008}.
