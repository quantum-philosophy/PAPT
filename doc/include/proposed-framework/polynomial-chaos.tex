...
In order to give a better intuition of what such a basis may look like, we have plotted in \fref{hermite} the first six polynomials $\{ \pcb_i(\z) \}_{i = 1}^6$, $\z \in \real$, of the Hermite basis in one dimension.
