The influence of the process variation on the dynamic power is known to be negligibly small \cite{juan2011, juan2012, srivastava2010}. Taking this into consideration, we let $\vP_\dyn(\t, \o) \equiv \vP_\dyn(\t)$. Hence, in \eref{power-model} we have
\[
