...
\newcommand{\fCov}[2]{K_{#1}\left(#2\right)}
...
% System profiles.
%
\newcommand{\part}[1]{\tau \left[ #1 \right]}
\newcommand{\prof}[1]{\left( #1, \part{#1} \right)}
\newcommand{\profB}[1]{\prof{#1}}
\newcommand{\profE}[1]{\prof{#1}}
