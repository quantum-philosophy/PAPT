...
% Submission
%
% Push all the figures and tables to the back
...
\newcommand{\oInvNataf}[1]{\mathbb{N}\text{ataf}^{\,-1}\left[#1\right]}
...
\newcommand{\Leff}{L}
\newcommand{\vLeff}{\v{\Leff}}
\newcommand{\nLeff}{\Leff_\text{nom}}
\newcommand{\gLeff}{{\delta \Leff^{(g)}}}
\newcommand{\lLeff}{\delta \Leff^{(l)}}
\newcommand{\vlLeff}{\delta \vLeff^{(l)}}
