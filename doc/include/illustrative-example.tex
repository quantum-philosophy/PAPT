In the development up to this point, we have not made any assumptions about the cause of variability of the source term, \ie, the power term, in the thermal system given by \eref{fourier-system}. In this section, we shall demonstrate the proposed UQ framework and, therefore, focus on a particular cause of uncertainty, namely, the leakage current under process variation.
