...
Having an appropriate basis chosen, we apply the PC procedure to power in \eref{ode-solution}. The resulting infinite series should be truncated to become feasible for practical computations. In this case, the expansion is defined as
