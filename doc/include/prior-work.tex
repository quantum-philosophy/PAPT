Right from the time when the first digital computers appeared in 1940s, Monte Carlo (MC) sampling remains one of the most well-known and widely used methods for the analysis of stochastic systems.
...
Then we applied the Jarque-Bera test of normality directly to the collected data as well as after processing them with the log transformation.
