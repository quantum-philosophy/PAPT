In the following subsections, the proposed framework is presented. We pursue generality such that the user can easily adjust the technique to a particular application.
