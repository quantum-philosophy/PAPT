...
\step{2}{Power Model Construction (\sref{power-model}).} A power model, which captures the effect of the uncertain parameters and of the temperature on the power dissipation of the processing elements within the system, is chosen at this stage.
