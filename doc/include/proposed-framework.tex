The main idea of our framework is to construct a surrogate model for the joint power and thermal models of the electronic system using the machinery of polynomial chaos (PC) expansions.
