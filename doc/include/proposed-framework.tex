...
\step{1}{Uncertain Parameters (\sref{uncertain-parameters}).} The theory of polynomial chaos (PC) expansions, empoled in this paper to perform UQ by constructing surrogate models, operates on a finite set of independent \rvs. The uncertain parameters $\vU(\o)$ might not satisfy this requirement and, therefore, should be first preprocessed; the output is denoted by $\vZ(\o)$.
